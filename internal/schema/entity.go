...
const (
	...
	GenerationTypeConst Generation = "const"   // Constant value. (will be identical for each row)
...
type Field struct {
	...
	ConstValue any        `json:"constValue" yaml:"constValue,omitempty"` // Constant value (if generation is Const)
