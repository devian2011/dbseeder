...
func (exporter *TableDependenceTreeExporter) Export() {
	exporter.tree.Walk(exporter.nodeHandler)
}

func (exporter *TableDependenceTreeExporter) nodeHandler(code string, node *schema.TableDependenceNode) {
	fmt.Println(code)
